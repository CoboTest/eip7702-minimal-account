#!/usr/bin/env python3
"""
E2E: ZeroDev Bundler + Paymaster (Python)

Pure Python implementation — no CLI tools.
...
async def main() -> None:
    ...
    logger.info("=" * 56)
    logger.info("  E2E ZeroDev — Bundler + Paymaster")
    ...
    logger.info("  Bundler:   %s", zerodev_bundler_url)
    logger.info("  Paymaster: %s", zerodev_paymaster_url)
    logger.info("")
    ...
    try:
        ...
        logger.info("[3b] Build UserOp + request ZeroDev sponsorship...")
        ...
        logger.info("[5] Submit UserOp via ZeroDev bundler (with eip7702Auth)...")
